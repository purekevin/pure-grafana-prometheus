...
wget -q --no-check-certificate https://10.21.224.167/pureuser/rft-prometheus-dashboard/-/raw/master/prometheus-all.yml
...
wget --no-check-certificate -q https://10.21.224.167/pureuser/rft-prometheus-dashboard/-/raw/master/grafana-all.db
chown grafana:grafana grafana-all.db
mv /var/lib/grafana/grafana.db /var/lib/grafana/grafana.db.orig2 2>/dev/null >/dev/null
